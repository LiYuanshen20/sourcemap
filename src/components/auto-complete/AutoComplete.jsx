...
import { Component, PropTypes } from 'element-react/dist/npm/es6/libs'
import Input from 'element-react/dist/npm/es6/src/input'
...
class AutoComplete extends Component {
  ...
  handleKeyEnter(highlightedIndex: number): void {
    if (
      ...
      highlightedIndex >= 0 &&
      highlightedIndex < this.state.suggestions.length
    ) {
  ...
  highlight(index: number): void {
    ...
    if (reference instanceof HTMLElement) {
      ...
      if (
        ...
        suggestionList instanceof NodeList
      ) {
  ...
  onCompositionStart(e: SyntheticKeyboardEvent<any>): void {
    this.props.onCompositionStart && this.props.onCompositionStart(e)
  }
  onCompositionEnd(e: SyntheticKeyboardEvent<any>): void {
    this.props.onCompositionEnd && this.props.onCompositionEnd(e)
  }
